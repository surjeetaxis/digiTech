...
export class StudentService {
  private ADD_STUDENT_URL = 'http://localhost:8080/api/student/add';
  private GET_ALL_STUDENTS_URL = 'http://localhost:8080/api/student/all';
  private GET_STUDENT_URL =
    'http://localhost:8080/api/student/details/{studentId}';
  private UPDATE_STUDENT_URL =
    'http://localhost:8080/api/student/update/{studentId}';
  private DELETE_STUDENT_URL =
    'http://localhost:8080/api/student/delete/{studentId}';
  private COUNT_CURRENT_STUDENT_URL =
    'http://localhost:8080/api/student/current/count';
  private COUNT_EX_STUDENT_URL = 'http://localhost:8080/api/student/past/count';
  ...
  addStudent(student: any): Promise<any> {
    return firstValueFrom(
      this.httpClient.post(this.ADD_STUDENT_URL, student, {
        responseType: 'json',
      })
    );
  }
  ...
  addStudentOb(student: any): Observable<any> {
    return this.httpClient.post(this.ADD_STUDENT_URL, student, {
      responseType: 'json',
    });
  }
  ...
  getAllStudents(tutorId: number): Promise<any> {
    ...
    return firstValueFrom(
      this.httpClient.get(this.GET_ALL_STUDENTS_URL, {
        params,
        responseType: 'json',
      })
    );
  ...
  getAllStudentsOb(tutorId: number) {
    const params = new HttpParams().set('tutorId', tutorId.toString());
    return this.httpClient.get<Student[]>(this.GET_ALL_STUDENTS_URL, {
      params,
    });
  }
  ...
  updateStudent(student: any, studentId: string): Promise<any> {
    ...
    return firstValueFrom(
      this.httpClient.put(url, student, { responseType: 'json' })
    );
  }
  ...
  countCurrentStudent(tutorId: number): Promise<any> {
    const params = new HttpParams().set('tutorId', tutorId.toString());
    return firstValueFrom(
      this.httpClient.get(this.COUNT_CURRENT_STUDENT_URL, {
        params,
        responseType: 'json',
      })
    );
  ...
  countExStudent(tutorId: number): Promise<any> {
    const params = new HttpParams().set('tutorId', tutorId.toString());
    return firstValueFrom(
      this.httpClient.get(this.COUNT_EX_STUDENT_URL, {
        params,
        responseType: 'json',
      })
    );
