...
export class TutorService {
  ...
  private GET_TUTOR_URL = 'http://localhost:8080/api/tutor/details/{tutorId}';
  private UPDATE_TUTOR_URL = 'http://localhost:8080/api/tutor/update/{tutorId}';
  private DELETE_TUTOR_PHOTO_URL =
    'http://localhost:8080/api/tutor/deletePhoto/{tutorId}';
  ...
  updateTutor(tutor: any, tutorId: string, image: Blob | null): Promise<any> {
    ...
    return firstValueFrom(
      this.httpClient.put(url, formData, { responseType: 'json' })
    );
  }
